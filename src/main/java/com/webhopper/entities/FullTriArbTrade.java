...
public class FullTriArbTrade {
    ...
    public FullTriArbTrade(TriArbTradeLeg leg1, TriArbTradeLeg leg2, TriArbTradeLeg leg3, BigDecimal profit, BigDecimal profitPercent) {
        this.leg1 = leg1;
        this.leg2 = leg2;
        this.leg3 = leg3;
        this.profit = profit;
